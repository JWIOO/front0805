...
import { sellingPromptsData } from "@/public/data/selling-prompts";

const BestPrompts = () => {
  return (
    <section className="section pb-0 best-prompts fade-wrapper">
      <div className="container">
        <div className="row">
          <div className="col-12">
            <div className="section__header text-start">
              <h2 className="title title-animation mt-12">(후보3)</h2>
            </div>
          </div>
        </div>
        <div className="row gaper">
          {sellingPromptsData.map((item) => {
            return (
              <div
